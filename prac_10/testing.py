...
def run_tests():
    ...
    # Test with fuel passed in
    test_car = Car(fuel=10)
    assert test_car.fuel == 10, "Car does not set fuel correctly when passed as an argument"
...
print(format_sentence('hello'))  # 'Hello.'
print(format_sentence('It is an ex parrot.'))  # 'It is an ex parrot.'
print(format_sentence('this is a valid test'))  # 'This is a valid test.'